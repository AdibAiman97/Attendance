      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><strong>STDC Administrator Dashboard</strong> </h1>
            <ol class="breadcrumb">
          ...
          <!-- Students Card -->
          <?php 
$query1=mysqli_query($conn,"SELECT DISTINCT admissionNumber FROM tblstudents");                       
...
?>
            ...
            <!-- Class Arm Card -->
             ...
             $query1 = mysqli_query($conn, "SELECT * FROM tblclassarms 
                              WHERE classId IN (SELECT classArmId FROM tblclassteacher )");                     
...
?>
            ...
            <!-- Teachers Card  -->
            <?php 
            $query1=mysqli_query($conn,"SELECT DISTINCT emailAddress FROM tblclassteacher");                       
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                          <div class="card h-100">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="text-xs font-weight-bold text-uppercase mb-1">STDC Staff</div>
            ...
            <?php 
            $query1=mysqli_query($conn,"SELECT * from tblsessionterm where isActive=1");                       
