...
$query = "SELECT tblclass.className, tblclassarms.classArmName, tblclass.Id as classId, tblclassarms.Id as classArmId 
          ...
          WHERE tblstudents.admissionNumber = '$_SESSION[emailAddress]'";
$rs = $conn->query($query);
$classData = [];
                      ...
                      <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        <tbody>
                          ...
                          if (isset($_POST['filter'])) {
                            ...
                            $admissionNumber = $_SESSION['emailAddress']; // Current student's admission number
                            ...
                            if ($dateType == "1") { // Single Date
                              ...
                              $query = "SELECT DISTINCT tblattendance.Id, tblattendance.status, tblattendance.dateTimeTaken, tblclass.className,
                                        ...
                                        tblstudents.firstName, tblstudents.lastName, tblstudents.otherName, tblstudents.admissionNumber, tblattendance.sessionType
                                        FROM tblattendance
                                        ...
                                        AND tblstudents.admissionNumber = '$admissionNumber'";
